...
const HrManagerLoginPage = () => {
  ...
  const loginMutation = useMutation({
    ...
    onSuccess: (data) => {
      ...
      localStorage.setItem('hr-manager', JSON.stringify(data.data));

      // Show success toast
      toast.success('Login successful! Redirecting to HR/Manager portal...');

      // Redirect to HR Manager dashboard after 1 second
      setTimeout(() => {
        navigate('/hr-manager-leave');
      }, 1000);
...
export default HrManagerLoginPage;
